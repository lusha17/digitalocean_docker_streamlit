...
def get_yolo5():
    ...
    return torch.hub.load('ultralytics/yolov5', 'custom', path='mask.pt', force_reload=True)
...
classes_selector = st.sidebar.multiselect('Select classes', CLASSES, default='mask')
